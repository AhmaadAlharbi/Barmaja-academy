...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Edit Content',
        href: `/courses/${props.course.id}/content/${props.content.id}/edit`,
    },
];

const form = useForm({
    title_en: props.content.title_en,
    title_ar: props.content.title_ar,
    content_en: props.content.content_en,
    content_ar: props.content.content_ar,
...
const submitForm = () => {
    ...
    form.put(`/courses/${props.course.id}/content/${props.content.id}`, {
        onFinish: () => {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Course Content</h1>
                    <p class="text-gray-600 dark:text-gray-400">
                        Editing: {{ props.content.title_en }} in {{ props.course.title_en }}
                    </p>
                </div>
